...
%Section 1.
rightToVote(citizen(X, Z), "Vote in Primary or other election for President or Vice President, for electors of President or Vice President, or for Senator or Representative in congress cannot be denied by any reason of failure to pay poll tax or other tax").
